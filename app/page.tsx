          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center h-16 md:h-20">
              <div className="flex items-center space-x-3 md:space-x-4">
                <div className="w-10 h-10 md:w-12 md:h-12 bg-gradient-to-br from-emerald-500 to-teal-600 rounded-xl md:rounded-2xl flex items-center justify-center shadow-lg md:shadow-2xl shadow-emerald-500/25">
              ...
              <div className="flex items-center space-x-3 md:space-x-6">
                <Link href="/dashboard">
                  <Button
                    variant="ghost"
                    size="sm"
                    className="text-gray-700 hover:text-emerald-700 hover:bg-emerald-50 transition-all duration-300 text-sm md:text-base px-3 md:px-4"
                  >
                    Dashboard
                  </Button>
                </Link>
                <Link href="/sign-in">
                  <Button
                    size="sm"
                    className="bg-gradient-to-r from-emerald-500 to-teal-600 hover:from-emerald-600 hover:to-teal-700 text-white shadow-lg md:shadow-xl shadow-emerald-500/25 hover:shadow-xl md:hover:shadow-2xl hover:shadow-emerald-500/40 transition-all duration-300 hover:scale-105 text-sm md:text-base px-3 md:px-4 py-2"
                  >
                    <span className="hidden sm:inline">Launch App</span>
                    <span className="sm:hidden">Launch</span>
                    <Rocket className="w-3 h-3 md:w-4 md:h-4 ml-1 md:ml-2" />
                  </Button>
                </Link>
              </div>
            </div>
